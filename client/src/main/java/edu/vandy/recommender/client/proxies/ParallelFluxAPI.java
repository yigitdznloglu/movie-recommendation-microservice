...
public interface ParallelFluxAPI {
    ...
    Flux<Ranking> recommendations(@RequestParam String watchedMovie, @RequestParam int maxCount);
    ...
    Flux<Ranking> recommendations(@RequestBody List<String> watchedMovies, @RequestParam int maxCount);
    ...
    Flux<Ranking> recommendationsTimed(@RequestParam String watchedMovie, @RequestParam int maxCount);
    ...
    Flux<Ranking> recommendationsTimed(@RequestBody List<String> watchedMovies, @RequestParam int maxCount);
}
