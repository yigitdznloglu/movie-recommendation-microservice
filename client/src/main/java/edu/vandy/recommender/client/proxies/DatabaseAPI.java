...
public interface DatabaseAPI {
     ...
     */
    // TODO -- you fill in here.
    @GET(ROUTE_NAME + "/" + GET_SEARCH + "/" + SEARCH_QUERY)
    Call<List<Movie>> searchMovies(@Path("routename") String routename, @Path("query") String query);
     ...
     */
    // TODO -- you fill in here.
    @POST(ROUTE_NAME + "/" + POST_SEARCHES)
    Call<List<Movie>> searchMovies(@Path("routename") String routename, @Body List<String> queries);
     ...
     */
    // TODO -- you fill in here.
    @POST(ROUTE_NAME + "/" + POST_SEARCHES_EX)
    Call<List<Movie>> searchMoviesEx(@Path("routename") String routename, @Body List<String> queries);
     ...
     */
    // TODO -- you fill in here.
    @GET(ROUTE_NAME + "/" + TIMED + "/" + GET_ALL_MOVIES)
     ...
     */
    // TODO -- you fill in here.
    @GET(ROUTE_NAME + "/" + TIMED + "/" + GET_MOVIES_MAP)
     ...
     */
    // TODO -- you fill in here.
    @GET(ROUTE_NAME + "/" + TIMED + "/" + GET_SEARCH + "/" + SEARCH_QUERY)
    Call<List<Movie>> searchMoviesTimed(@Path("routename") String routename, @Path("query") String query);
     ...
     */
    // TODO -- you fill in here.
    @POST(ROUTE_NAME + "/" + TIMED + "/" + POST_SEARCHES)
    Call<List<Movie>> searchMoviesTimed(@Path("routename") String routename, @Body List<String> queries);
     ...
     */
    // TODO -- you fill in here.
    @POST(ROUTE_NAME + "/" + TIMED + "/" + POST_SEARCHES_EX)
    Call<List<Movie>> searchMoviesExTimed(@Path("routename") String routename, @Body List<String> queries);
}
