...
public class DatabaseSyncProxy {
    ...
    public List<Movie> getMovies(String route) {
        ...
        return CallUtils.executeCall(mDatabaseAPI.getMovies(route));
    }
    ...
    public Map<String, List<Double>> getMoviesMap(String route) {
        ...
        return CallUtils.executeCall(mDatabaseAPI.getMoviesMap(route));
    }
    ...
    public List<Movie> searchMovies(String route,
        ...
        return CallUtils.executeCall(mDatabaseAPI.searchMovies(route, query));
    }
    ...
    public List<Movie> searchMovies(String route,
        ...
        return CallUtils.executeCall(mDatabaseAPI.searchMovies(route, queries));
    }
    ...
    public List<Movie> searchMoviesEx(String route,
        ...
        return CallUtils.executeCall(mDatabaseAPI.searchMoviesEx(route, queries));
    }
    ...
    public List<Movie> getMoviesTimed(String route) {
        ...
        return CallUtils.executeCall(mDatabaseAPI.getMoviesTimed(route));
    }
    ...
    public Map<String, List<Double>> getMoviesMapTimed(String route) {
        ...
        return CallUtils.executeCall(mDatabaseAPI.getMoviesMapTimed(route));
    }
    ...
    public List<Movie> searchMoviesTimed(String route,
        ...
        return CallUtils.executeCall(mDatabaseAPI.searchMoviesTimed(route, query));
    }
    ...
    public List<Movie> searchMoviesTimed(String route,
        ...
        return CallUtils.executeCall(mDatabaseAPI.searchMoviesTimed(route, queries));
    }
    ...
    public List<Movie> searchMoviesExTimed(String route,
        ...
        return CallUtils.executeCall(mDatabaseAPI.searchMoviesExTimed(route, queries));
    }
}
